		...
		if(ho!=null){
			...
			//	if (dateservidor.after(ho.getValidezinicio()) && dateservidor.before(ho.getValidezfin())){
					...
					if(ultimaasistencia!=null && ultimaasistencia.getFechainiciomarcado()==null ){
						...
						botones.setMensaje("El usuario ya terminó su ciclo de asistencia, el siguiente estará habilitado desde el "+tmformat+".");
...
///////////////////////////////////////////cumpleaños/////////////////////////////////////////////
				...
				eventorepetido.setDescription("Cumpleaños de ");
				Evento eventonuevo=new Evento();
				eventonuevo.setDescription("Cumpleaños de ");
				int eventosnuevos=0;
							...
							if(fechanacimientod.after(tem)){
									...
									for(Evento g:listadoeventosnuevos){
									 ...
									 eventonuevo=new Evento();
										...
										eventonuevo.setTitle("Cumpleaños");
